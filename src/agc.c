...
GtkWidget* buildAgcUI() {
    ...
    agcTable=gtk_table_new(2,4,TRUE);
    ...
    gtk_table_attach_defaults(GTK_TABLE(agcTable),buttonSLOW,1,2,0,1);
    ...
    gtk_table_attach_defaults(GTK_TABLE(agcTable),buttonMEDIUM,2,3,0,1);
    ...
    gtk_table_attach_defaults(GTK_TABLE(agcTable),buttonFAST,0,1,1,2);
    ...
    gtk_table_attach_defaults(GTK_TABLE(agcTable),buttonLONG,1,2,1,2);
